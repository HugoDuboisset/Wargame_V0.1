...
public class AssaultResolutionServiceTests
{
    ...
    public void ResolveMelee_Should_Apply_Terrain_Initiative_Bonus_To_Defender_In_First_Round()
    {
        ...
        var attackerFig = new Figure(Guid.NewGuid(), 1, StandardBaseSizeMm, new Position(0, 0));
        ...
        var defenderFig = new Figure(Guid.NewGuid(), 1, StandardBaseSizeMm, new Position(10, 10)); // Dans le terrain
